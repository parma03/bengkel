...
<head>
    <title>Administrator Management | Datta Able Dashboard Template</title>
    <!-- [Meta] -->
    <meta charset="utf-8" />
...
<body>
            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="page-header-title">
                        <h5 class="mb-0 font-medium">Administrator Management</h5>
                    </div>
                    <ul class="breadcrumb">
            ...
            <div class="grid grid-cols-12 gap-x-6">
                <div class="col-span-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="administratorTable" class="display" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Foto</th>
                                ...
                                <tbody>
                                    <?php foreach ($administrators as $index => $admin): ?>
                                        <tr>
                                            <td><?= $index + 1 ?></td>
                                            <td>
                                                <img src="<?= $admin['photo_profile'] ? '../../assets/images/profile/' . $admin['photo_profile'] : '../../assets/images/profile/avatar-2.jpg' ?>"
                                                    alt="Avatar" class="avatar">
                                            </td>
                                            <td><?= htmlspecialchars($admin['nama']) ?></td>
                                            <td><?= htmlspecialchars($admin['nohp']) ?></td>
                                            <td><?= htmlspecialchars($admin['email']) ?></td>
                                            <td><span class="badge bg-primary"><?= ucfirst($admin['role']) ?></span></td>
                                            <td><?= date('d/m/Y H:i', strtotime($admin['created_at'])) ?></td>
                                            <td>
                                                <button class="btn btn-success btn-sm" onclick="viewAdmin(<?= $admin['id_user'] ?>)">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <button class="btn btn-warning btn-sm" onclick="editAdmin(<?= $admin['id_user'] ?>)">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                <button class="btn btn-danger btn-sm" onclick="deleteAdmin(<?= $admin['id_user'] ?>)">
    ...
    <div id="adminModal" class="modal-overlay">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modalTitle">Tambah Administrator</h4>
            ...
            <div class="modal-body">
                <form id="adminForm" enctype="multipart/form-data" method="POST">
                    ...
                    <input type="hidden" name="id_user" id="adminId">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    <i class="fas fa-eye"></i> Detail Administrator
                </h4>
    ...
    <script>
        ...
        // Administrator data for JavaScript
        const administrators = <?= json_encode($administrators) ?>;

        // Open create modal
        function openCreateModal() {
            document.getElementById('modalTitle').innerHTML = '<i class="fas fa-plus"></i> Tambah Administrator';
        ...
        function viewAdmin(id) {
            const admin = administrators.find(a => a.id_user == id);
            if (admin) {
                const photoSrc = admin.photo_profile ?
                    '../../assets/images/profile/' + admin.photo_profile :
            ...
            <div class="view-profile-section">
                ...
                <div class="view-profile-name">${admin.nama}</div>
                <div class="view-profile-role">${admin.role.charAt(0).toUpperCase() + admin.role.slice(1)}</div>
            </div>
            <div class="view-details">
                <div class="detail-item">
                    ...
                    <div class="detail-content">
                        ...
                        <div class="detail-value">${admin.nohp}</div>
                    </div>
                </div>
                <div class="detail-item">
                    <div class="detail-icon">
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-content">
                        ...
                        <div class="detail-value">${new Date(admin.created_at).toLocaleDateString('id-ID', {
                            year: 'numeric',
                            month: 'long',
                            day: 'numeric',
                            hour: '2-digit',
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-content">
                        ...
                        <div class="detail-value">${new Date(admin.updated_at).toLocaleDateString('id-ID', {
                            year: 'numeric',
                            month: 'long',
                            day: 'numeric',
                            hour: '2-digit',
        ...
        function editAdmin(id) {
            const admin = administrators.find(a => a.id_user == id);
            if (admin) {
                document.getElementById('modalTitle').innerHTML = '<i class="fas fa-edit"></i> Edit Administrator';
                document.getElementById('formAction').value = 'update';
                document.getElementById('submitBtn').innerHTML = '<i class="fas fa-save"></i> Update';
                document.getElementById('adminId').value = admin.id_user;
                document.getElementById('oldPhoto').value = admin.photo_profile || '';
                document.getElementById('nama').value = admin.nama;
                document.getElementById('nohp').value = admin.nohp;
                ...
                if (admin.photo_profile) {
                    preview.src = '../../assets/images/profile/' + admin.photo_profile;
                    preview.classList.remove('hidden');
        ...
        function deleteAdmin(id) {
            ...
            <div style="text-align: center; margin: 20px 0;">
                ...
                <p style="font-size: 1.1rem; margin-bottom: 10px;">Apakah Anda yakin ingin menghapus administrator:</p>
                <p style="font-size: 1.3rem; font-weight: 600; color: #333;">${admin ? admin.nama : 'ini'}</p>
